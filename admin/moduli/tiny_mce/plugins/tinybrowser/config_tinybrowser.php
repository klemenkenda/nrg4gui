...
$tinybrowser['obfuscate'] = 'c0sys1n3rgi5E';
...
$tinybrowser['path']['image'] = '/slike/upload/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/slike/upload/'; // Media files location
$tinybrowser['path']['file']  = '/datoteke/dokumenti/'; // Other files location
